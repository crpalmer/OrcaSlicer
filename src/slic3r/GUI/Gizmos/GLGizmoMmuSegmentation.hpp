...
public:
    ...
    // ORCA mixed filament: the paint material limit follows EnforcerBlockerType::ExtruderMax.
    // TriangleSelector serialization supports the extended (17..32) range via an escape nibble.
