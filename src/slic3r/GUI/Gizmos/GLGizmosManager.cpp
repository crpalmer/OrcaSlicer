        ...
        // BBS
            ...
            if (mmu_seg != nullptr) {
                ...
                if (keyCode >= '0' && keyCode <= '9') {
                    // ORCA mixed filament: support two-digit color shortcuts so extruders up to
                    // EXTRUDERS_LIMIT (32) can be selected from the keyboard.
...
{
    // ORCA mixed filament: the timer fired before a second digit arrived — commit the pending
    // single-digit color shortcut.
